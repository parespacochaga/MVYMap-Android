...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	protected void setupView(Context context, final ViewGroup parent) {
		...
		View v = inflater.inflate(R.layout.mvymaps_balloon_overlay, parent);
		title = (TextView) v.findViewById(R.id.mvymaps_balloon_item_title);
		snippet = (TextView) v.findViewById(R.id.mvymaps_balloon_item_snippet);
